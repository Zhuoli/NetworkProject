...
public class Snark
{
        ...
        throws IOException
    {
		...
		// Set up a container to record peers information, 
		// clistener: storage listener
        coordinator = new PeerCoordinator(id, meta, storage, clistener);
        HttpAcceptor httpacceptor;
        if (ip != null) {
		/*Tell other peers that add this peer to this torrent clients list*/
			...
			// Accepts incomming http connections.
