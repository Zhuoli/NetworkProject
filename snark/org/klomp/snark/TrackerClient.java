...
public class TrackerClient extends Thread
{
    ...
    public void run ()
    {
        ...
        try {
            ...
            //**************************************************************
            long startMili = System.currentTimeMillis(); // Modification: Get start time.
            //**************************************************************
            ...
            while (!stop) {
                ...
                if (!completed && coordinator.completed()) {
                    ...
                    //**************************************************************
                    long endMili = System.currentTimeMillis(); // Modification: Get end time.
                    System.out.println("The Download Total time: " + (endMili - startMili) + "ms"); // Modification: Print the tatal time.
                    //**************************************************************
